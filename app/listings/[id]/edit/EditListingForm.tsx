...
export default function EditListingForm({ listing }: { listing: Listing }) {
  ...
  const [selectedEmoji, setSelectedEmoji] = useState<string | null>(listing.emoji ?? null);
  const [imageUrl, setImageUrl] = useState<string | null>((listing as any).imageUrl ?? null);
  ...
  return (
    <main className="max-w-3xl mx-auto px-4 pt-14 pb-8 w-full flex-1">
      ...
      <h1 className="text-2xl font-semibold text-ink mb-6">Edit item</h1>
      ...
      <form action={formAction} className="space-y-5">
        ...
        <div>
          ...
          <div className="relative">
            ...
            <input
              ...
              min="0"
              required
              defaultValue={listing.minimumBid}
        ...
        <div>
          ...
          <input
            ...
            type="url"
            placeholder="https://…"
            defaultValue={listing.externalLink ?? ""}
            className="w-full border border-ink/20 rounded-md px-4 py-2.5 text-ink bg-white focus:outline-none focus:ring-2 focus:ring-green focus:border-transparent text-base"
          />
        </div>
